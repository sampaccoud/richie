...
class SectionTests(CMSPluginTestCase):
    ...
    def test_section_title_level(self):
        """
        Title level can be changed from context variable 'header_level'.
        """
        # We deliberately use level '10' since it can be substituted from any
        # reasonable default level.
        title_format = """<h10 class="section__title">{}</h10>"""
        ...
        # Expected title markup should match given 'header_level' context
        # variable
        self.assertInHTML(expected_title, html)
